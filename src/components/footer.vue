<template>
  <footer class="bg-[#fffdf9] border-t border-gray-200 mt-auto">
    <div
      class="px-4 sm:px-6 md:px-[8%] lg:px-[12%] xl:px-[15%] py-12 sm:py-14 md:py-16"
    >
      <div
        class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12"
      >
        <!-- Company Info -->
        <div class="space-y-3 sm:space-y-4">
          <h3 class="text-2xl sm:text-3xl md:text-4xl font-bold text-[#560216]">
            IRIS SPACES
          </h3>
        ...
        <!-- Why Choose Us -->
        <div class="space-y-3 sm:space-y-4">
          <h4 class="text-base sm:text-lg font-semibold text-[#560216]">
            WHY CHOOSE US
          </h4>
          <p class="text-gray-700 text-sm sm:text-base leading-relaxed">
        ...
        <div class="space-y-3 sm:space-y-4">
          ...
          <ul class="space-y-2 text-sm sm:text-base text-gray-700">
            ...
            <li>Training, event, and exhibition spaces</li>
            <li>Meeting rooms</li>
            <li>iris pods</li>
            <li>Virtual desk</li>
            <li>Focus group facility</li>
            <li>CLT (Central Location Test) facility</li>
          </ul>
        </div>
